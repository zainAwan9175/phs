...
<div style="background:var(--mint);min-height:calc(100vh - 300px);padding:48px 24px">
  ...
  <div style="max-width:700px;margin:0 auto">
    ...
    <div style="background:#fff;padding:48px;border-radius:32px;box-shadow:0 6px 12px rgba(0,0,0,0.08)">
      ...
      <h1 style="text-align:center;color:#2d3b7a;font-size:32px;margin:0 0 32px;font-weight:800">Report Issue</h1>
      
      <form method="POST" action="?page=manager_report_issue_action">
        ...
        <div style="margin-bottom:24px">
          <label style="display:block;margin-bottom:8px;font-weight:600;color:#333;font-size:15px">Details</label>
          <textarea name="details" rows="5" required placeholder="Describe the issue in detail" style="width:100%;padding:14px;border-radius:8px;border:1px solid #e0e0e0;font-size:15px;background:#fff;resize:vertical;font-family:inherit"></textarea>
        </div>
        
        <!-- Submit Button -->
        <div style="text-align:center">
          <button type="submit" style="background:#dc3545;color:#fff;padding:14px 48px;border-radius:28px;border:none;cursor:pointer;font-size:16px;font-weight:700;box-shadow:0 4px 0 rgba(0,0,0,0.1)">Report</button>
        </div>
