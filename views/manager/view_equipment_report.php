...
<div style="background:#49BBBD;min-height:100vh;padding:40px 20px">
  <div style="max-width:1200px;margin:0 auto">
    ...
    <div style="background:#fff;padding:40px;border-radius:16px;box-shadow:0 4px 6px rgba(0,0,0,0.07)">
      ...
      <!-- Student Info -->
      <div style="margin-bottom:32px;padding-bottom:24px;border-bottom:2px solid #e5e7eb">
        <h2 style="color:#2d3b7a;font-size:24px;margin:0 0 20px;font-weight:700">Student</h2>
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));gap:20px">
          <div>
            <label style="display:block;color:#6b7280;font-size:13px;font-weight:600;margin-bottom:4px">STUDENT NAME</label>
      ...
      <div style="display:flex;gap:12px;justify-content:flex-end;padding-top:24px;border-top:2px solid #e5e7eb">
        <a href="?page=manager_equipment_reports" style="display:inline-block;padding:14px 32px;border-radius:10px;border:2px solid #d1d5db;color:#6b7280;text-decoration:none;font-weight:600;transition:all 0.2s">
          Close
        </a>
        <a href="?page=manager_delete_equipment_report&id=<?php echo $report['id']; ?>" onclick="return confirm('Are you sure you want to delete this report?')" style="display:inline-block;background:#dc2626;color:#fff;padding:14px 32px;border-radius:10px;text-decoration:none;font-weight:600;transition:all 0.2s;box-shadow:0 4px 0 rgba(0,0,0,0.1)">
          🗑️ Delete Report
        </a>
      </div>
    </div>
